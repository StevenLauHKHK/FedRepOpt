...
from config_centralized import get_config
from data import build_loader_central
...
def main(config):
    dataset_train, dataset_val, data_loader_train, data_loader_val, mixup_fn = build_loader_central(config)
