...
def save_latest(config, epoch, model, max_accuracy, optimizer, lr_scheduler, logger, c_model_dir_name=None, model_ema=None):
    ...
    # save client model in FL
    if c_model_dir_name != None:
        save_path = os.path.join(config.OUTPUT, c_model_dir_name, 'latest.pth')
    else:
