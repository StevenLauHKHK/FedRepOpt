...
_C.DATA.DATA_PATH = '/data_ssd/yasar/tiny-imagenet-200'
_C.DATA.ANNOTATIONS_FED = "annotations_fed_alpha_1e5_clients_10" # "annotations_fed_alpha_0.1_clients_10"

# Dataset name
_C.DATA.DATASET = 'tiny_imagenet'
# Input image size
_C.DATA.IMG_SIZE = 64
